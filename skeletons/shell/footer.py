...
class Footer(Gtk.Box):
    ...
    def __init__(self):
        ...
        self.cluster = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=24)
        self.cluster.set_halign(Gtk.Align.CENTER)
        self.cluster.set_valign(Gtk.Align.CENTER)
        add_class(self.cluster, "nav-cluster")
        ...
        self.cluster.append(_nav_cell(self.tuner_btn, "TUNER"))
        self.cluster.append(_nav_cell(self.scope_btn, "SCOPE"))
        self.cluster.append(self.tuner_strip)
        self.cluster.append(_nav_cell(self.mode_btn, "MODE"))
        self.cluster.append(_nav_cell(self.info_btn, "INFO"))
